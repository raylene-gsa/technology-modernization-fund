...
The TMF will consider technology-related projects from all federal agencies. Agencies are encouraged to review the [Additional Considerations]({{ site.baseurl }}{% link _pages/document/addl-considerations.md %}) document and the [Initial Product Proposal template]({{ site.baseurl }}{% link _pages/documents.md %}).
