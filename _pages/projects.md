...
The identification of additional internal funds allowed DOE to continue making progress on the goals of the original project scope during the adjudication of the bid protest that was successfully adjudicated in favor of the Department. DOE will still achieve the full benefits of the original TMF proposal through the use of internal funds and the reduced TMF allocation, and the scope change makes available TMF resources that can be reallocated to additional project proposals. 
