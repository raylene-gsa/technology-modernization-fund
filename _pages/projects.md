...
This project will allow the Department of Education (ED) to create and fully implement a zero trust architecture plan across the enterprise to increase the security of the vast volume of citizen data the department maintains. As current and emerging cloud, multi-cloud, and hybrid network environments continue to develop in complexity and breadth, the nature of adversary threats continues to rapidly evolve and challenges the efficacy of traditional cybersecurity architectures. ED currently holds a third of the population’s personal identifiable information (PII) and manages one of the largest portfolios in accounts receivable for federal student aid. Data protection of citizen information is a critical priority area. 

Without this funding, the Department of Education will not be able to implement a zero trust architecture that can adequately protect its information resources to keep up with today’s dynamic cyber threat landscape. This can leave a large portion of the American public vulnerable to malicious attacks by both cyber criminals and malicious nation state actors. However, with this TMF funding ED will enact a zero trust Program over a span of two years that includes strategy, architecture, design, and an implementation roadmap. ED will also establish a catalog of services with Secure Access Service Edge (SASE) and security orchestration, automation and response (SOAR) technologies. The department will stand up an enterprise-wide program management office dedicated to zero trust as well as adopt an advanced architecture across cloud-computing environments in accordance with the developed roadmap. By improving and modernizing cybersecurity technologies the Department will provide more secure and less burdensome user experiences both for employees and citizens.
...
This project will allow the General Services Administration (GSA) to modernize legacy network systems and implement an advanced zero trust architecture (ZTA). As technologies continue to evolve and in light of recent cyber attacks on the federal government, GSA needs to accelerate their cybersecurity modernization from their current traditional state to an advanced zero trust architecture. Additionally, the continued adoption of multi-domain, hybrid cloud environments demands  more modern systems and capabilities to ensure continuous visibility, analytics, and security posture management, and complete end-to-end security. 
 
Without this funding, GSA would experience delays in developing production capabilities to mitigate the risks of future supply chain attacks and implementing controls to prevent intrusions by nation state adversaries, as well as increased GSA costs for duplicative capabilities. However, with this TMF funding GSA will advance their cyber architecture from traditional to advanced by focusing on three blocks: Users and Devices, Networks, and Security Operations. Within the first block, GSA will replace their 20-year-old directory designs with a more modern implementation to meet the newer demands of telework and a multi-domain, hybrid cloud architecture approach with virtualization adhering to the enhanced security principles. They will also develop a modernized enterprise single-sign-on (SSO) to include new multi-factor authentication options. In the second block, GSA will focus on microsegmentation by leveraging a secure access service edge (SASE) solution and upgrading their public buildings security network to ward off challenges associated with ransomware. Lastly, they will adopt increased machine learning and artificial intelligence driven algorithms to help connect diverse data sources and highlight threats while providing security oversight for cyber supply chain risk management and enhancing core security operations centers to include governmentwide public facing digital services. 

By implementing these modernization efforts, GSA will improve user experience through seamless global connection to GSA managed environments and applications while maintaining ZTA principles. It will improve cybersecurity capabilities to continually verify the security of users, devices, applications, and data as well as achieve broad-based visibility across the GSA ecosystem with enhanced capabilities leveraging automation to manage and respond to threats in more real-time.
...
This project will allow the General Services Administration (GSA) to further scale the Login.gov shared service with advanced cybersecurity capabilities, identity verification coverage, and agency adoption services.Currently, Login.gov has 30+ million active users who use 200+ public digital services that are provided by 27 agencies. Despite this success, without a shared service that effectively serves the entire population including the underserved and vulnerable populations facing barriers to remote identity proofing, agencies have attempted to stand up their own systems leading the federal government to repeatedly pay for what is effectively the same service. Further, as non-mission centric systems, investments in these systems continue to decrease over time and do not maintain modern security best practices. This leads to the inability of agencies to keep up with the evolving digital identity landscape, poor user experience and major security vulnerabilities.

Without this funding, Login.gov has had to decline or delay integrations with agency systems which has delayed or put at risk delivery of government services. As a result, agencies have implemented solutions that don’t meet secure authentication and identity verification standards, and they lack stringent privacy protections. This has led to security breaches of government services and has compromised public users’ benefits and personal information. 
However, with this TMF funding GSA will increase Login.gov’s cybersecurity posture for 30+ million active users, and protect their data. Furthermore, it will add equitable identity verification technology solutions, and in-person verification options for vulnerable populations. This project will fund user growth, by ultimately reducing the barrier of entry for agencies. The operational benefits of this project include mitigating the risks associated with increasing identity verification services to all agencies and millions of people,  while at the same time reducing costs at scale. Login.gov will be able to reduce risks associated with increased cyber attacks, misuse (fraud), delays and lack of coverage.
...
This project allows the Department of Homeland Security (DHS) to modernize system infrastructures and capacities to meet the current 20-year migration flow highs across the Southwest Border (SWB) while planning for future challenges. Recently, there have been record numbers of individuals seeking access to the United States who require intake, review, and processing. DHS and its partner agencies and departments, such as Customs and Border Protection (CBP), the Department of Justice (DOJ), and Health and Human Services (HHS) also have an urgent need to meet the  logistics of family groups and unaccompanied children at the border while also tackling complications due to the COVID-19 global pandemic. DHS’s internal funding streams have been greatly reduced due to COVID-19 and budget reprioritization to respond to the overwhelming urgent needs at the Southern Border.

Without this funding, DHS will have to wait to replace the remaining outdated manual data processes and modernize legacy data systems, and will be challenged to facilitate efficient and timely process review of undocumented individuals, protect unaccompanied children, reunify families, and appropriately manage medical information needed by state and local authorities to continue protections for those indivudals released into the U.S. However, with this TMF funding the Southwest Border Technology Integration Program (TIP) will provide standardized and secure data sharing across the enterprise and throughout the immigration lifecycle to improve border flow and capacity management, enhance transparency, and expedite processing through automation and technical efficiencies, ultimately resulting in more humane management of the immigrant population. DHS will modernize legacy systems and leverage advances in technology to develop an integrated picture of predicted non-citizen flows across the southern land border, compare the data to current and planned future capacity models across DHS’s subgroups and HHS to inform actions based on migrant categorizations, and use the data to more accurately communicate operational challenges to the public and external governmental stakeholders.
...
This project allows the General Services Administration (GSA) to enhance MAX.gov to provide a modernized, secure cloud-based solution for cross agency collaboration, authentication, and other shared services capabilities.MAX.gov usage has significantly increased in the 14 years since its deployment, and dozens of agencies rely on the system for mission critical operations. MAX.gov is currently at a critical juncture where the technology is outdated and increased demand is affecting scalability. The current system is scheduled to be decommissioned in FY23, which would leave customers without the technology resources needed to execute mission functions.

Without TMF funding, the project will incur delays that will impact TTS’s ability to complete partner and product transition, ultimately affecting agency and OMB operations. However, with this TMF funding GSA will focus on creating modern cloud based authentication and collaboration products for government organizations on a fee-for-service basis.As a fee-for-service model, the project team is focused on keeping fees affordable to agencies.The revenue projections support DM&E work to continue modernization activities, provide new cloud based capabilities, and enhance user experience. 
