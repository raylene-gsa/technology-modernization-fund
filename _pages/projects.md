...
This project will allow the U.S. Department of Education (ED) to create and fully implement a zero trust architecture plan across the enterprise to increase the security of the vast volume of citizen data the department maintains.
 
As current and emerging cloud, multi-cloud, and hybrid network environments continue to develop in complexity and breadth, the nature of the threats from our adversaries continues to rapidly evolve and challenges the efficacy of traditional cybersecurity architectures. ED currently holds a third of the U.S. population’s personally identifiable information (PII) and manages one of the largest loan portfolios in the world. Data protection of citizen information is a critical priority area.
...
Without this funding, the Department of Education will not be able to implement a zero trust architecture that can provide robust protection of its information resources to keep up with today’s dynamic cyber threat landscape. This can leave a large portion of the American public more vulnerable to malicious attacks by both cyber criminals and malicious nation state actors. 
...
As technologies continue to evolve and in light of recent cyber attacks on the federal government, GSA needs to accelerate their cybersecurity modernization from their current traditional state to an advanced zero trust architecture. Additionally, the continued adoption of multi-domain, hybrid cloud environments demands more modern systems and capabilities to ensure continuous visibility, analytics, and security posture management, and complete end-to-end security. 
 
Using TMF Funds, GSA will advance their cybersecurity architecture by focusing on three blocks: Users and Devices, Networks, and Security Operations. Within the first block, GSA will replace their 20-year-old directory designs with a more modern implementation to meet the newer demands of telework and a multi-domain, hybrid cloud architecture approach with virtualization adhering to enhanced security principles. GSA will also develop a modernized enterprise single-sign-on (SSO) to include new multi-factor authentication options. In the second block, GSA will focus on microsegmentation by leveraging a secure access service edge (SASE) solution and upgrading their public buildings’ security network to defend against challenges associated with ransomware. Lastly, GSA will adopt increased machine learning and artificial intelligence driven algorithms to help connect diverse data sources and highlight threats while providing security oversight for cyber supply chain risk management and enhancing core security operations centers to include governmentwide public-facing digital services. 
...
Without TMF funding, GSA would experience delays in developing production capabilities to mitigate the risks of future supply chain attacks and implementing controls to prevent intrusions by nation state adversaries, as well as increased GSA costs for duplicative capabilities. 
...
Without this funding to scale their capacity, Login.gov has had to decline or delay integrations with agency systems, which has delayed or put at risk delivery of government services. As a result, agencies have implemented solutions that don’t meet secure authentication and identity verification standards, and lack stringent privacy protections. This has created elevated security risks to government services and public users’ benefits and personal information.
The TMF funding will serve three purposes. First, it will increase cybersecurity identification and protection for current and future users. Second, it will add equitable identity verification and in-person options for vulnerable populations. Third, it will grow the Login.gov environment by reducing the barrier to entry for agencies to allow for Login.gov to increase usage to a higher percentage of citizen participation.
 
The operational benefits of this project include increasing identity verification services, reducing fraud, expanding access to digital services for millions of citizens, and reducing government-wide costs at scale. 
...
Without TMF funding, the project will incur delays that will impact TTS’s ability to complete partner and product transition, ultimately affecting agency and OMB operations. As a fee-for-service model, the project team is focused on keeping fees affordable to agencies. The revenue projections support Development, Modernization, and Enhancements (DM&E) work to continue modernization activities, provide new cloud-based capabilities, and enhance user experience.
